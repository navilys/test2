...
abstract class BaseAbeConfiguration extends BaseObject  implements Persistent {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setAbeUid($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setProUid($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setTasUid($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setAbeType($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setAbeTemplate($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setAbeDynType($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setDynUid($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setAbeEmailField($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setAbeActionField($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setAbeCaseNoteInResponse($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setAbeCreateDate($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setAbeUpdateDate($arr[$keys[11]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AbeConfigurationPeer::ABE_UID)) $criteria->add(AbeConfigurationPeer::ABE_UID, $this->abe_uid);
		if ($this->isColumnModified(AbeConfigurationPeer::PRO_UID)) $criteria->add(AbeConfigurationPeer::PRO_UID, $this->pro_uid);
		if ($this->isColumnModified(AbeConfigurationPeer::TAS_UID)) $criteria->add(AbeConfigurationPeer::TAS_UID, $this->tas_uid);
		if ($this->isColumnModified(AbeConfigurationPeer::ABE_TYPE)) $criteria->add(AbeConfigurationPeer::ABE_TYPE, $this->abe_type);
		if ($this->isColumnModified(AbeConfigurationPeer::ABE_TEMPLATE)) $criteria->add(AbeConfigurationPeer::ABE_TEMPLATE, $this->abe_template);
		if ($this->isColumnModified(AbeConfigurationPeer::ABE_DYN_TYPE)) $criteria->add(AbeConfigurationPeer::ABE_DYN_TYPE, $this->abe_dyn_type);
		if ($this->isColumnModified(AbeConfigurationPeer::DYN_UID)) $criteria->add(AbeConfigurationPeer::DYN_UID, $this->dyn_uid);
		if ($this->isColumnModified(AbeConfigurationPeer::ABE_EMAIL_FIELD)) $criteria->add(AbeConfigurationPeer::ABE_EMAIL_FIELD, $this->abe_email_field);
		if ($this->isColumnModified(AbeConfigurationPeer::ABE_ACTION_FIELD)) $criteria->add(AbeConfigurationPeer::ABE_ACTION_FIELD, $this->abe_action_field);
		if ($this->isColumnModified(AbeConfigurationPeer::ABE_CASE_NOTE_IN_RESPONSE)) $criteria->add(AbeConfigurationPeer::ABE_CASE_NOTE_IN_RESPONSE, $this->abe_case_note_in_response);
		if ($this->isColumnModified(AbeConfigurationPeer::ABE_CREATE_DATE)) $criteria->add(AbeConfigurationPeer::ABE_CREATE_DATE, $this->abe_create_date);
		if ($this->isColumnModified(AbeConfigurationPeer::ABE_UPDATE_DATE)) $criteria->add(AbeConfigurationPeer::ABE_UPDATE_DATE, $this->abe_update_date);
