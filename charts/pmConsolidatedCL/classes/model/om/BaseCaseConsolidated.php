...
abstract class BaseCaseConsolidated extends BaseObject  implements Persistent {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setConStatus($arr[$keys[3]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CaseConsolidatedPeer::TAS_UID)) $criteria->add(CaseConsolidatedPeer::TAS_UID, $this->tas_uid);
		if ($this->isColumnModified(CaseConsolidatedPeer::DYN_UID)) $criteria->add(CaseConsolidatedPeer::DYN_UID, $this->dyn_uid);
		if ($this->isColumnModified(CaseConsolidatedPeer::REP_TAB_UID)) $criteria->add(CaseConsolidatedPeer::REP_TAB_UID, $this->rep_tab_uid);
		if ($this->isColumnModified(CaseConsolidatedPeer::CON_STATUS)) $criteria->add(CaseConsolidatedPeer::CON_STATUS, $this->con_status);
