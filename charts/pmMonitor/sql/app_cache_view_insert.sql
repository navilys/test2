...
SELECT
  ...
  USERS.USR_LASTNAME + ' ' + USERS.USR_FIRSTNAME AS APP_CURRENT_USER,
  APP_LAST_USER.USR_LASTNAME + ' ' + APP_LAST_USER.USR_FIRSTNAME AS APP_DEL_PREVIOUS_USER,
  APP_DELEGATION.DEL_PRIORITY,
  APP_DELEGATION.DEL_DURATION,
  APP_DELEGATION.DEL_QUEUE_DURATION,
  APP_DELEGATION.DEL_DELAY_DURATION,

  CASE APP_DELEGATION.DEL_INIT_DATE  WHEN NULL THEN 0 ELSE 1 END,
  CASE APP_DELEGATION.DEL_FINISH_DATE  WHEN NULL THEN 0 ELSE 1 END,
