<?php
require_once (PATH_PLUGINS . "enterprise" . PATH_SEP . "classes" . PATH_SEP . "model" . PATH_SEP . "om" . PATH_SEP . "BaseAddonsManager.php");
...
class AddonsManager extends BaseAddonsManager {
  ...
  public function download() {
    ...
    for ($i = 0; $position >= 1024 && $i < 4; $i++) $position /= 1024;
    for ($j = 0; $rate >= 1024 && $j < 4; $j++) $rate /= 1024;
  ...
  public function install() {
    ...
    if ($this->isPlugin()) {
      ...
      if ($this->getAddonType() == "core") {
        require_once PATH_PLUGINS . "enterprise/classes/class.Upgrade.php";
