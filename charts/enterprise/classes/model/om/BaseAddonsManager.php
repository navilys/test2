...
abstract class BaseAddonsManager extends BaseObject  implements Persistent {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setAddonId($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setStoreId($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setAddonName($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setAddonNick($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setAddonDownloadFilename($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setAddonDescription($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setAddonState($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setAddonStateChanged($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setAddonStatus($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setAddonVersion($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setAddonType($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setAddonPublisher($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setAddonReleaseDate($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setAddonReleaseType($arr[$keys[13]]);
		if (array_key_exists($keys[14], $arr)) $this->setAddonReleaseNotes($arr[$keys[14]]);
		if (array_key_exists($keys[15], $arr)) $this->setAddonDownloadUrl($arr[$keys[15]]);
		if (array_key_exists($keys[16], $arr)) $this->setAddonDownloadProgress($arr[$keys[16]]);
		if (array_key_exists($keys[17], $arr)) $this->setAddonDownloadMd5($arr[$keys[17]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AddonsManagerPeer::ADDON_ID)) $criteria->add(AddonsManagerPeer::ADDON_ID, $this->addon_id);
		if ($this->isColumnModified(AddonsManagerPeer::STORE_ID)) $criteria->add(AddonsManagerPeer::STORE_ID, $this->store_id);
		if ($this->isColumnModified(AddonsManagerPeer::ADDON_NAME)) $criteria->add(AddonsManagerPeer::ADDON_NAME, $this->addon_name);
		if ($this->isColumnModified(AddonsManagerPeer::ADDON_NICK)) $criteria->add(AddonsManagerPeer::ADDON_NICK, $this->addon_nick);
		if ($this->isColumnModified(AddonsManagerPeer::ADDON_DOWNLOAD_FILENAME)) $criteria->add(AddonsManagerPeer::ADDON_DOWNLOAD_FILENAME, $this->addon_download_filename);
		if ($this->isColumnModified(AddonsManagerPeer::ADDON_DESCRIPTION)) $criteria->add(AddonsManagerPeer::ADDON_DESCRIPTION, $this->addon_description);
		if ($this->isColumnModified(AddonsManagerPeer::ADDON_STATE)) $criteria->add(AddonsManagerPeer::ADDON_STATE, $this->addon_state);
		if ($this->isColumnModified(AddonsManagerPeer::ADDON_STATE_CHANGED)) $criteria->add(AddonsManagerPeer::ADDON_STATE_CHANGED, $this->addon_state_changed);
		if ($this->isColumnModified(AddonsManagerPeer::ADDON_STATUS)) $criteria->add(AddonsManagerPeer::ADDON_STATUS, $this->addon_status);
		if ($this->isColumnModified(AddonsManagerPeer::ADDON_VERSION)) $criteria->add(AddonsManagerPeer::ADDON_VERSION, $this->addon_version);
		if ($this->isColumnModified(AddonsManagerPeer::ADDON_TYPE)) $criteria->add(AddonsManagerPeer::ADDON_TYPE, $this->addon_type);
		if ($this->isColumnModified(AddonsManagerPeer::ADDON_PUBLISHER)) $criteria->add(AddonsManagerPeer::ADDON_PUBLISHER, $this->addon_publisher);
		if ($this->isColumnModified(AddonsManagerPeer::ADDON_RELEASE_DATE)) $criteria->add(AddonsManagerPeer::ADDON_RELEASE_DATE, $this->addon_release_date);
		if ($this->isColumnModified(AddonsManagerPeer::ADDON_RELEASE_TYPE)) $criteria->add(AddonsManagerPeer::ADDON_RELEASE_TYPE, $this->addon_release_type);
		if ($this->isColumnModified(AddonsManagerPeer::ADDON_RELEASE_NOTES)) $criteria->add(AddonsManagerPeer::ADDON_RELEASE_NOTES, $this->addon_release_notes);
		if ($this->isColumnModified(AddonsManagerPeer::ADDON_DOWNLOAD_URL)) $criteria->add(AddonsManagerPeer::ADDON_DOWNLOAD_URL, $this->addon_download_url);
		if ($this->isColumnModified(AddonsManagerPeer::ADDON_DOWNLOAD_PROGRESS)) $criteria->add(AddonsManagerPeer::ADDON_DOWNLOAD_PROGRESS, $this->addon_download_progress);
		if ($this->isColumnModified(AddonsManagerPeer::ADDON_DOWNLOAD_MD5)) $criteria->add(AddonsManagerPeer::ADDON_DOWNLOAD_MD5, $this->addon_download_md5);
