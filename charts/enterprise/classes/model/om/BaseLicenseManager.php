...
abstract class BaseLicenseManager extends BaseObject  implements Persistent {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setLicenseUid($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setLicenseUser($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setLicenseStart($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setLicenseEnd($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setLicenseSpan($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setLicenseStatus($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setLicenseData($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setLicensePath($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setLicenseWorkspace($arr[$keys[8]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LicenseManagerPeer::LICENSE_UID)) $criteria->add(LicenseManagerPeer::LICENSE_UID, $this->license_uid);
		if ($this->isColumnModified(LicenseManagerPeer::LICENSE_USER)) $criteria->add(LicenseManagerPeer::LICENSE_USER, $this->license_user);
		if ($this->isColumnModified(LicenseManagerPeer::LICENSE_START)) $criteria->add(LicenseManagerPeer::LICENSE_START, $this->license_start);
		if ($this->isColumnModified(LicenseManagerPeer::LICENSE_END)) $criteria->add(LicenseManagerPeer::LICENSE_END, $this->license_end);
		if ($this->isColumnModified(LicenseManagerPeer::LICENSE_SPAN)) $criteria->add(LicenseManagerPeer::LICENSE_SPAN, $this->license_span);
		if ($this->isColumnModified(LicenseManagerPeer::LICENSE_STATUS)) $criteria->add(LicenseManagerPeer::LICENSE_STATUS, $this->license_status);
		if ($this->isColumnModified(LicenseManagerPeer::LICENSE_DATA)) $criteria->add(LicenseManagerPeer::LICENSE_DATA, $this->license_data);
		if ($this->isColumnModified(LicenseManagerPeer::LICENSE_PATH)) $criteria->add(LicenseManagerPeer::LICENSE_PATH, $this->license_path);
		if ($this->isColumnModified(LicenseManagerPeer::LICENSE_WORKSPACE)) $criteria->add(LicenseManagerPeer::LICENSE_WORKSPACE, $this->license_workspace);
		if ($this->isColumnModified(LicenseManagerPeer::LICENSE_TYPE)) $criteria->add(LicenseManagerPeer::LICENSE_TYPE, $this->license_type);
