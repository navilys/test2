...
include_once 'classes/model/KtProcessPeer.php';

/**
 * Base class that represents a row from the 'KT_PROCESS' table.
 *
 * 
 *
 * @package    model.om
 */
abstract class BaseKtProcess extends BaseObject  implements Persistent {
	...
	public function setProUid($v)
	{
		...
		if ($this->pro_uid !== $v || $v === '') {
			$this->pro_uid = $v;
			$this->modifiedColumns[] = KtProcessPeer::PRO_UID;
		}
	...
	public function setKtFolderId($v)
	{
		...
		if ($this->kt_folder_id !== $v || $v === 0) {
			$this->kt_folder_id = $v;
			$this->modifiedColumns[] = KtProcessPeer::KT_FOLDER_ID;
		}
	...
	public function setKtParentId($v)
	{
		...
		if ($this->kt_parent_id !== $v || $v === 0) {
			$this->kt_parent_id = $v;
			$this->modifiedColumns[] = KtProcessPeer::KT_PARENT_ID;
		}
	...
	public function setKtFolderName($v)
	{
		...
		if ($this->kt_folder_name !== $v || $v === '') {
			...
			$this->modifiedColumns[] = KtProcessPeer::KT_FOLDER_NAME;
		}
	...
	public function setKtFullPath($v)
	{
		...
		if ($this->kt_full_path !== $v || $v === '') {
			$this->kt_full_path = $v;
			$this->modifiedColumns[] = KtProcessPeer::KT_FULL_PATH;
		}
	...
	public function setKtCreateUser($v)
	{
		...
		if ($this->kt_create_user !== $v || $v === '') {
			...
			$this->modifiedColumns[] = KtProcessPeer::KT_CREATE_USER;
		}
	...
	public function setKtCreateDate($v)
	{
		...
		if ($this->kt_create_date !== $ts) {
			...
			$this->modifiedColumns[] = KtProcessPeer::KT_CREATE_DATE;
		}
	...
	public function setKtUpdateDate($v)
	{
		...
		if ($this->kt_update_date !== $ts) {
			...
			$this->modifiedColumns[] = KtProcessPeer::KT_UPDATE_DATE;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->kt_create_user = $rs->getString($startcol + 5);

			$this->kt_create_date = $rs->getTimestamp($startcol + 6, null);

			$this->kt_update_date = $rs->getTimestamp($startcol + 7, null);
			...
			return $startcol + 8; // 8 = KtProcessPeer::NUM_COLUMNS - KtProcessPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating KtProcess object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		if ($con === null) {
			$con = Propel::getConnection(KtProcessPeer::DATABASE_NAME);
		}

		try {
			$con->begin();
			KtProcessPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = KtProcessPeer::doInsert($this, $con);
					...
					$affectedRows += KtProcessPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = KtProcessPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = KtProcessPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = KtProcessPeer::getFieldNames($keyType);
		$result = array(
			...
			$keys[5] => $this->getKtCreateUser(),
			$keys[6] => $this->getKtCreateDate(),
			$keys[7] => $this->getKtUpdateDate(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setKtCreateUser($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setKtCreateDate($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setKtUpdateDate($arr[$keys[7]]);
	}
	...
	{
		$criteria = new Criteria(KtProcessPeer::DATABASE_NAME);

		if ($this->isColumnModified(KtProcessPeer::PRO_UID)) $criteria->add(KtProcessPeer::PRO_UID, $this->pro_uid);
		if ($this->isColumnModified(KtProcessPeer::KT_FOLDER_ID)) $criteria->add(KtProcessPeer::KT_FOLDER_ID, $this->kt_folder_id);
		if ($this->isColumnModified(KtProcessPeer::KT_PARENT_ID)) $criteria->add(KtProcessPeer::KT_PARENT_ID, $this->kt_parent_id);
		if ($this->isColumnModified(KtProcessPeer::KT_FOLDER_NAME)) $criteria->add(KtProcessPeer::KT_FOLDER_NAME, $this->kt_folder_name);
		if ($this->isColumnModified(KtProcessPeer::KT_FULL_PATH)) $criteria->add(KtProcessPeer::KT_FULL_PATH, $this->kt_full_path);
		if ($this->isColumnModified(KtProcessPeer::KT_CREATE_USER)) $criteria->add(KtProcessPeer::KT_CREATE_USER, $this->kt_create_user);
		if ($this->isColumnModified(KtProcessPeer::KT_CREATE_DATE)) $criteria->add(KtProcessPeer::KT_CREATE_DATE, $this->kt_create_date);
		if ($this->isColumnModified(KtProcessPeer::KT_UPDATE_DATE)) $criteria->add(KtProcessPeer::KT_UPDATE_DATE, $this->kt_update_date);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(KtProcessPeer::PRO_UID, $this->pro_uid);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of KtProcess (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     KtProcess Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     KtProcessPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new KtProcessPeer();
		}
		return self::$peer;
	}
