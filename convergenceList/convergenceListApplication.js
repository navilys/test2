Ext.namespace("convergenceList");

convergenceList.application = {
  init:function(){
    storeUserProcess = function (n, r, i) {
      ...
      Ext.Ajax.request({
        url: "convergenceListApplicationAjax",
        method: "POST",
...
Ext.onReady(convergenceList.application.init, convergenceList.application);