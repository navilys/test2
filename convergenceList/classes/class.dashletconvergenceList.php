...
class dashletconvergenceList implements DashletInterface
{
  const version = '1.0';
  ...
  public function render($width = 300)
  {
    ...
    ///////
    $dashletView = new dashletconvergenceListView($arrayUser, $this->note);
...
class dashletconvergenceListView extends Smarty
{
  private $smarty;
  ...
  public function __construct($u, $n)
  {
    ...
    $this->smarty->templateFile = PATH_PLUGINS . "convergenceList" . PATH_SEP . "views" . PATH_SEP . "dashletconvergenceList.html";
  }
