Ext.namespace("stepconvergenceList");

stepconvergenceList.application = {
  init:function(){
    storeApplicationProcess = function () {
      ...
      Ext.Ajax.request({
        url: "../convergenceList/stepconvergenceListApplicationAjax",
        method: "POST",
...
Ext.onReady(stepconvergenceList.application.init, stepconvergenceList.application);