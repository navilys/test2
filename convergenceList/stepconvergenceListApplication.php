...
try {
  ...
  $oHeadPublisher->addContent("convergenceList/stepconvergenceListApplication"); //Adding a html file .html.
  $oHeadPublisher->addExtJsScript("convergenceList/stepconvergenceListApplication", false); //Adding a javascript file .js
