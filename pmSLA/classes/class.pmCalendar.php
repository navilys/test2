...
class pmCalendar
{
    ...
    public function showLog ($log)
    {
        ...
        foreach ($log as $value) {
            ...
            $html .= '<td aling="center">' . $value['0'] . '</td>';
            $html .= '<td aling="center">' . $value['1'] . '</td>';
            $html .= '<td aling="center">' . $value['2'] . '</td>';
            $html .= '<td aling="center">' . $value['3'] . '</td>';
            $html .= '<td aling="center">' . $value['4'] . '</td>';
            $html .= '<td aling="center">' . $value['5'] . '</td>';
            $html .= '<td aling="center">' . $value['6'] . '</td>';
