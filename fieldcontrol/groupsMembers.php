...
$oHeadPublisher->addExtJsScript(PATH_PLUGINS.SYS_COLLECTION.'/groupsMembers', false, true);    //adding a javascript file .js
$oHeadPublisher->addContent('fieldcontrol/groupsMembers'); //adding a html file  .html.
