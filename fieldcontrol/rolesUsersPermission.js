...
Ext.onReady(function(){
	...
	storeP = new Ext.data.GroupingStore( {
        proxy : new Ext.data.HttpProxy({
            url: '../roles/data_rolesPermissions?rUID=' + ROLES.ROL_UID + '&type=list'
          }),
	...
	storeA = new Ext.data.GroupingStore( {
        proxy : new Ext.data.HttpProxy({
            url: '../roles/data_rolesPermissions?rUID=' + ROLES.ROL_UID + '&type=show'
          }),
    	reader : new Ext.data.JsonReader( {
    		root: 'permissions',
    		fields : [
    ...
    storeU = new Ext.data.GroupingStore({
    	proxy : new Ext.data.HttpProxy({
            url: '../roles/data_rolesUsers?rUID=' + ROLES.ROL_UID + '&type=list'
          }),
    	reader : new Ext.data.JsonReader( {
    		root: 'users',
    		fields : [
    ...
    storeX = new Ext.data.GroupingStore({
    	proxy : new Ext.data.HttpProxy({
            url: '../roles/data_rolesUsers?rUID=' + ROLES.ROL_UID + '&type=show'
          }),
    	reader : new Ext.data.JsonReader( {
    		root: 'users',
    		fields : [
