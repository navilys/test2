...
class dashletfieldcontrol implements DashletInterface
{
  const version = '1.0';
  ...
  public function render($width = 300)
  {
    ...
    ///////
    $dashletView = new dashletfieldcontrolView($arrayUser, $this->note);
...
class dashletfieldcontrolView extends Smarty
{
  private $smarty;
  ...
  public function __construct($u, $n)
  {
    ...
    $this->smarty->templateFile = PATH_PLUGINS . "fieldcontrol" . PATH_SEP . "views" . PATH_SEP . "dashletfieldcontrol.html";
  }
