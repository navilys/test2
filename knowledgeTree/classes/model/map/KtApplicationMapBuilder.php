...
/**
 * This class adds structure of 'KT_APPLICATION' table to 'workflow' DatabaseMap object.
 *
 *
 *
 ...
 * @package    model.map
 */
class KtApplicationMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'model.map.KtApplicationMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('KT_APPLICATION');
		$tMap->setPhpName('KtApplication');
		...
		$tMap->addColumn('KT_FOLDER_OUTPUT', 'KtFolderOutput', 'int', CreoleTypes::INTEGER, true, null);

		$tMap->addColumn('KT_FOLDER_ATTACHMENT', 'KtFolderAttachment', 'int', CreoleTypes::INTEGER, true, null);

		$tMap->addColumn('KT_FOLDER_EMAIL', 'KtFolderEmail', 'int', CreoleTypes::INTEGER, true, null);
