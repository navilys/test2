<?php
require_once (PATH_PLUGINS . "enterprise/classes/model/om/BaseAddonsStore.php");
G::LoadClass("system");
...
class AddonsStore extends BaseAddonsStore
{
    ...
    public static function addonList()
    {
        ...
        //list($stores, $errors)  = AddonsStore::updateAll(isset($_REQUEST["force"]));
        list($stores, $errors)  = AddonsStore::updateAll(false);
        //$result["store_errors"] = $errors;
    ...
    public function update($force=false)
    {
        ...
        ///////
        //$secondsSinceUpdate = time() - strtotime($this->getStoreLastUpdated());
        //if (!$force && ($secondsSinceUpdate < 60 * 60)) {
        //  return false;
        //}
        ///////
