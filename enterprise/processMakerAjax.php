...
switch ($option) {
    case "install":
        ...
        try {
            ...
            ///////
            $dir = PATH_DATA . "upgrade/processmaker";
            ...
            if (EnterpriseUtils::checkFolderPermissions($path, true) == false) {
                $str = "The $path directory, its sub-directories or file is not writable. Read the wiki for <a href=\"http://wiki.processmaker.com/index.php/Upgrading_ProcessMaker\" onclick=\"window.open(this.href, '_blank'); return (false);\">Upgrading ProcessMaker</a>.<br />
                        The file is downloaded in $fileName.<br />";
