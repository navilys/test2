...
class dashletaquitaineProject implements DashletInterface
{
  const version = '1.0';
  ...
  public function render($width = 300)
  {
    ...
    ///////
    $dashletView = new dashletaquitaineProjectView($arrayUser, $this->note);
...
class dashletaquitaineProjectView extends Smarty
{
  private $smarty;
  ...
  public function __construct($u, $n)
  {
    ...
    $this->smarty->templateFile = PATH_PLUGINS . "aquitaineProject" . PATH_SEP . "views" . PATH_SEP . "dashletaquitaineProject.html";
  }
