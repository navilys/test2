Ext.namespace("aquitaineProject");

aquitaineProject.application = {
  init:function(){
    storeUserProcess = function (n, r, i) {
      ...
      Ext.Ajax.request({
        url: "aquitaineProjectApplicationAjax",
        method: "POST",
...
Ext.onReady(aquitaineProject.application.init, aquitaineProject.application);