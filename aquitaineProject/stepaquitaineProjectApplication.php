...
try {
  ...
  $oHeadPublisher->addContent("aquitaineProject/stepaquitaineProjectApplication"); //Adding a html file .html.
  $oHeadPublisher->addExtJsScript("aquitaineProject/stepaquitaineProjectApplication", false); //Adding a javascript file .js
