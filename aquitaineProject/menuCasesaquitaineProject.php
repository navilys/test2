...
foreach ($G_TMP_MENU->Id as $index => $value) {
  if ($index == 3) { //Option CASES_INBOX
    $tmpId[$index + $k]      = "ID_AQUITAINEPROJECT_MNUCASE_01";
    $tmpTypes[$index + $k]   = "plugins";
    $tmpEnabled[$index + $k] = 1;
    $tmpOptions[$index + $k] = "../aquitaineProject/aquitaineProjectApplication"; //link
    $tmpLabels[$index + $k]  = "aquitaineProject application1";
    $tmpJS[$index + $k]      = null;
...
$tmpId[$i]      = "ID_AQUITAINEPROJECT_MNUCASE_02";
$tmpTypes[$i]   = "blockHeader";
$tmpEnabled[$i] = 1;
$tmpOptions[$i] = null; //link
$tmpLabels[$i]  = "aquitaineProject application2";
$tmpJS[$i]      = null;
$tmpIcons[$i]   = null;
$tmpEClass[$i]  = null;
...
$tmpId[$i]      = "ID_AQUITAINEPROJECT_MNUCASE_03";
$tmpTypes[$i]   = "plugins";
$tmpEnabled[$i] = 1;
$tmpOptions[$i] = "../aquitaineProject/aquitaineProjectApplication2"; //link
$tmpLabels[$i]  = "aquitaineProject application2";
$tmpJS[$i]      = null;
$tmpIcons[$i]   = null;
$tmpEClass[$i]  = null;
...
$tmpId[$i]      = "ID_AQUITAINEPROJECT_MNUCASE_04";
$tmpTypes[$i]   = "blockHeaderNoChild";
$tmpEnabled[$i] = 1;
$tmpOptions[$i] = "../aquitaineProject/aquitaineProjectApplication3"; //link
$tmpLabels[$i]  = "aquitaineProject application3";
$tmpJS[$i]      = null;
$tmpIcons[$i]   = null;
$tmpEClass[$i]  = null;
