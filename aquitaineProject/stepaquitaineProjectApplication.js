Ext.namespace("stepaquitaineProject");

stepaquitaineProject.application = {
  init:function(){
    storeApplicationProcess = function () {
      ...
      Ext.Ajax.request({
        url: "../aquitaineProject/stepaquitaineProjectApplicationAjax",
        method: "POST",
...
Ext.onReady(stepaquitaineProject.application.init, stepaquitaineProject.application);