...
abstract class BasePmReportPermissions extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the pmrp_type field.
	 * @var        string
	 */
	protected $pmrp_type = '';
	...
	/**
	 * Get the [pmrp_type] column value.
	 * 
	 * @return     string
	 */
	public function getPmrpType()
	{

		return $this->pmrp_type;
	}
	...
	public function setUsrUid($v)
	{
		...
		if ($this->usr_uid !== $v || $v === '') {
			$this->usr_uid = $v;
			$this->modifiedColumns[] = PmReportPermissionsPeer::USR_UID;
		}

	} // setUsrUid()

	/**
	 * Set the value of [pmrp_type] column.
	 * 
	 * @param      string $v new value
	 * @return     void
	 */
	public function setPmrpType($v)
	{
		...
		if ($this->pmrp_type !== $v || $v === '') {
			$this->pmrp_type = $v;
			$this->modifiedColumns[] = PmReportPermissionsPeer::PMRP_TYPE;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->pmrp_type = $rs->getString($startcol + 2);
			...
			return $startcol + 3; // 3 = PmReportPermissionsPeer::NUM_COLUMNS - PmReportPermissionsPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setPmrpType($arr[$keys[2]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PmReportPermissionsPeer::USR_UID)) $criteria->add(PmReportPermissionsPeer::USR_UID, $this->usr_uid);
		if ($this->isColumnModified(PmReportPermissionsPeer::PMRP_TYPE)) $criteria->add(PmReportPermissionsPeer::PMRP_TYPE, $this->pmrp_type);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PmReportPermissionsPeer::USR_UID, $this->usr_uid);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setPmrpType($this->pmrp_type);
